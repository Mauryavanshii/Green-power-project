...
<Link
to='/boiler/propertyplace/housebuiltyear'
 >
      ...
      <div class='h-[320px] w-[270px] rounded-[10px] flex items-center justify-center
        ...
        <img src="https://getyourquote.greenenergyhomes.ie/unique-image/previous.png" 
        alt="" class='h-[100px] w-[90px] ' />

        <h1 class='text-[15px] mt-[80px] text-center font-bold '>Pre2000</h1>
...
<Link >
      ...
      outline outline-0 hover:outline-1 hover:outline-blue-500 '>
        <img src="		https://getyourquote.greenenergyhomes.ie/unique-image/next.png" 
        alt="" class='h-[100px] w-[90px] ' />

        <h1 class='text-[15px] mt-[80px] text-center font-bold'>Post2000
        </h1>
      </div>
      </Link>
