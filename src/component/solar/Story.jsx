...
export default function Story() {
    return (
      ...
      outline outline-0 hover:outline-1 hover:outline-blue-500  bg-white flex-col mt-[40px] '>
                        <img src="https://getyourquote.greenenergyhomes.ie/unique-image/dining-table.png"
                            alt="" class='h-[100px] w-[90px] ' />

                        <h1 class='text-[20px] mt-[80px] font-bold'>One Stories</h1>
                    </div>
                </Link>
                <Link
                to='/solar/homepro' >
       ...
       outline outline-0 hover:outline-1 hover:outline-blue-500 '>
                        <img src="	https://getyourquote.greenenergyhomes.ie/unique-image/house-front-of-three-floors.png"
                            alt="" class='h-[100px] w-[90px] ' />

                        <h1 class='text-[20px] mt-[80px] font-bold'>Three stories</h1>
                    </div>
                </Link>
                <Link
                to='/solar/homepro' >
